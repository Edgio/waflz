...
//! ----------------------------------------------------------------------------
//! \details Access maxmind db using mmdb file, pass in IP addr, get subdivision iso code from entry, input string in first two params
//! \return  WAFLZ status code
//! \param   ao_buf: char of subdivision iso code string
//!          ao_buf_len: str length
//!          a_ip: ip address char
//!          a_ip_len: ip length
//! ----------------------------------------------------------------------------
